...
draw_text(_textX, _textY - 160, "X Position: " + string(x));
draw_text(_textX, _textY - 180, "Y Position: " + string(y));
draw_text(_textX, _textY - 200, "inAttackRange: " + string(inAttackRange));
